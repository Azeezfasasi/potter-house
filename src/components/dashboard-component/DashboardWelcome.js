    ...
    <section className="bg-white rounded-lg shadow-sm p-5 md:p-6 lg:p-8">
      <div className="flex flex-col lg:flex-row md:items-center md:justify-between gap-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center w-14 h-14 rounded-lg bg-gradient-to-br from-purple-800 to-purple-900 text-white text-xl font-bold">
            {firstName.charAt(0).toUpperCase()}
          </div>

          <div>
            <h1 className="text-lg md:text-2xl font-semibold text-gray-900">
              {greeting}, <span className="text-purple-900">{firstName}</span>
            </h1>
        ...
        <div className="flex flex-col lg:flex-row md:items-center gap-3">
          <Link href="/dashboard/all-programmes" className="inline-flex justify-center items-center gap-2 px-3 py-1 md:py-2 bg-purple-900 text-white rounded-md text-sm hover:bg-purple-800 cursor-pointer">
            <Briefcase />
            Manage Programmes
          </Link>

          <Link href="/dashboard/send-newsletter" className="inline-flex justify-center items-center gap-2 px-3 py-1 md:py-2 border bg-gray-100 border-gray-200 rounded-md text-sm text-gray-700 hover:bg-gray-50 cursor-pointer">
            <NotepadText />
            Send Campaign
          </Link>
        </div>
